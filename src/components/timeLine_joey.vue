    ...
    <div>
        ...
        <ol>
            <li>
                ...
                <p class="event-description">HTML Tags, an informal CERN document listing 18 HTML tags, was first
            ...
            <li>
                ...
                <p class="event-description">HTML DTD 1.1 the first revision with a version number, an informal draft.
                </p>
            </li>
            <li>
                <p class="event-date">June 1993</p>
                <p class="event-description">Hypertext Markup Language published by the IETF IIIR Working Group as an
                    Internet Draft. </p>
            </li>
            <li>
            ...
            <li>
                ...
                <p class="event-description">"ISO HTML", based on HTML 4.01 Strict was published as an ISO/IEC
